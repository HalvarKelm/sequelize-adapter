...
exports.updateCasbinRule = exports.CasbinRule = void 0;
...
function updateCasbinRule(tableName = 'casbin_rule', schema) {
    const options = sequelize_typescript_1.getOptions(CasbinRule.prototype);
    options.tableName = tableName;
    options.schema = schema;
    sequelize_typescript_1.setOptions(CasbinRule.prototype, options);
}
exports.updateCasbinRule = updateCasbinRule;
